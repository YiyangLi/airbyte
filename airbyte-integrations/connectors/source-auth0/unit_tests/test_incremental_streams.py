...
from source_auth0.source import IncrementalAuth0Stream


@fixture
def patch_incremental_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(IncrementalAuth0Stream, "path", "v0/example_endpoint")
...
def test_supports_incremental(patch_incremental_base_class, mocker):
    mocker.patch.object(IncrementalAuth0Stream, "cursor_field", "dummy_field")
    stream = IncrementalAuth0Stream()
