...
The source connector is for [Auth0 Management API](https://auth0.com/docs/api/authentication#introduction)
...
2. Click **Copy Token**. 
3. In the airbyte, choose **OAuth2 Access Token** under the **Authentication Method** menu, Paste the token to the text box of **OAuth2 Access Token**
...
4. Select the Management API V2, the api you want call from Airbyte.
...
5. More details can be found from [this documentation](https://auth0.com/docs/secure/tokens/access-tokens/get-management-api-access-tokens-for-production).
